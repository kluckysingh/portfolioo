                ...
                <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay showStatus={false} showThumbs={false} >
                    <div className={classes.image_container} >
                        ...
                        <div className={classes.h1}>
                            <h1 >I'm Lucky</h1>
                            <a href="https://drive.google.com/file/d/1w6suvsv76JpZcuskgSQsWmZke944ahv2/view?usp=drivesdk" rel="opener noreferrer" target="_blank">VIEW CV   <FaArrowCircleDown /></a>
                        </div>
                    </div>
                    <div className={classes.image_container}>
                        ...
                        <div className={classes.h2}>
                            ...
                            <h1>THINGS!!</h1>
                            <a href="https://github.com/kluckysingh?tab=repositories" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject /></a>
                        </div>
                    </div>
                    {/* <div className={classes.image_container}>
